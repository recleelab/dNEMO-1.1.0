...
%% function which creates a z-profile for an indicated object
%
%  INPUT:
%  . INSPECT - inspector application handle
%  . image - image object 
%  . spotInfo - spot information structure
%  . true_ind - pointer indicating current object to display in the
%  inspector, referencing the entry in spotInfo's 'objCoords' field
%
%  OUTPUT:
%  . raw_zdata - profile to plot along the inspector's z-display axis
%  . frames - z-frames that the object appears in
%
