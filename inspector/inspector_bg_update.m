...
%% graphics object callback fcn for user manipulating background collection data
%
%  INPUT:
% . hand - graphics object event handle
% . evt - mouse event click
% . INSPECT - structure denoting INSPECTOR figure handle
%
%  OUTPUT:
% . none
%
